...
const GENRE_COMPATIBILITY: Record<string, string[]> = {
  ...
  'SERTANEJO': ['sertanejo', 'country', 'sertão', 'caipira', 'modão'],
  'Rock': ['rock', 'alternative', 'indie', 'punk', 'metal', 'grunge', 'hard rock', 'classic rock'],
  'ROCK': ['rock', 'alternative', 'indie', 'punk', 'metal', 'grunge', 'hard rock', 'classic rock'],
  'Metal': ['metal', 'rock', 'heavy metal', 'thrash', 'death metal', 'hardcore', 'metalcore'],
  'METAL': ['metal', 'rock', 'heavy metal', 'thrash', 'death metal', 'hardcore', 'metalcore'],
