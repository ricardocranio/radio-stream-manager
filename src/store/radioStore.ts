...
const defaultStations: RadioStation[] = [
  ...
  },
  {
    id: 'jovempan',
    name: 'Jovem Pan',
    urls: ['https://onlineradiobox.com/br/jovempan/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/jovem-pan-fm-442891/',
    styles: ['POP/VARIADO', 'HITS'],
    enabled: true,
  },
  {
    id: 'mix',
    name: 'Mix FM',
    urls: ['https://onlineradiobox.com/br/mix/playlist/'],
  ...
  },
  {
    id: 'nativa',
    name: 'Nativa FM',
    urls: ['https://onlineradiobox.com/br/nativa/playlist/'],
  ...
  },
  {
    id: 'antena1',
    name: 'Antena 1',
    urls: ['https://onlineradiobox.com/br/antena1/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/antena-1-sao-paulo-473422/',
    styles: ['POP/VARIADO', 'FLASHBACK'],
    enabled: true,
  },
  {
    id: 'transamerica',
    name: 'Transamérica',
    urls: ['https://onlineradiobox.com/br/transamerica/playlist/'],
  ...
  },
  {
    id: 'alpha',
    name: 'Alpha FM',
    urls: ['https://onlineradiobox.com/br/alpha/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/alpha-fm-474152/',
    styles: ['POP/VARIADO', 'ADULTO CONTEMPORÂNEO'],
    enabled: false,
  },
  {
    id: 'metropolitana',
    name: 'Metropolitana FM',
    urls: ['https://onlineradiobox.com/br/metropolitana/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/metropolitana-fm-464018/',
    styles: ['SERTANEJO', 'PAGODE'],
    enabled: false,
  },
  {
    id: '89fm',
    name: '89 FM',
    urls: ['https://onlineradiobox.com/br/a89fm/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/radio-89-fm-414866/',
    styles: ['ROCK', 'POP/VARIADO'],
    enabled: false,
  },
  {
    id: 'kissfm',
    name: 'Kiss FM',
    urls: ['https://onlineradiobox.com/br/kissfm/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/kiss-fm-sao-paulo-431802/',
    styles: ['ELETRÔNICA', 'POP/VARIADO'],
    enabled: false,
  },
  {
    id: 'novabrasil',
    name: 'Nova Brasil FM',
    urls: ['https://onlineradiobox.com/br/novabrasil/playlist/'],
    scrapeUrl: 'https://mytuner-radio.com/pt/radio/nova-brasil-fm-sao-paulo-429012/',
    styles: ['MPB', 'POP BRASILEIRO'],
    enabled: false,
  },
];
