...
interface ElectronAPI {
  ...
  cleanupOldDayFiles: (params: { folder: string; onlyKeepToday?: boolean }) => Promise<{ success: boolean; deletedCount: number; deletedFiles: string[]; keptDays: string[]; error?: string }>;
  ...
  processTempFiles: (params: { musicFolders: string[] }) => Promise<{ processed: number; moved: number; skipped: number; errors: number; details: Array<{ file: string; correctName?: string; status: string; error?: string }> }>;
